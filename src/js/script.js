...
//            center: [55.8505, 37.5380], // координаты центра на карте
...
//            geometry: {
//                type: "Point",
//                coordinates: [55.8505, 37.5380] // координаты, где будет размещаться флажок на карте
//            }
//        });
...
//                loadScript("https://api-maps.yandex.ru/2.1/?apikey=(ca954d3d-7686-48ad-83d2-18b3b60643d8)&lang=ru_RU", function () {
